...
| --- | --- | --- |
| `public/favicon.ico` | https://39donuts.ru/favicon.ico?favicon.f364ab3d.ico | оригинальная иконка вкладки ICO, 6 размеров до 256×256; подключена на главной странице и в презентационном макете |
...
В папке также сохранены вспомогательные файлы исходного сайта, которые не отображаются на текущей странице: hero-wordmark, декоративная donut-полоса, иконки шагов и контактов. Пять файлов `blocks__partners__partners_img_1.svg` … `blocks__partners__partners_img_5.svg` сохранены как исходные материалы, но в итоговых шагах не отображаются. Их URL строятся напрямую из имени: `https://39donuts.ru/` + исходный путь, где двойное подчёркивание в локальном имени заменяет `/`.

## Новый графический элемент

- `public/assets/concept/donut-scroll-thumb-variety.png` — уменьшенная копия специально созданной для этого концепта объёмной стопки из восьми пончиков с разной глазурью. Используется как бегунок основного скролла на компьютере.
